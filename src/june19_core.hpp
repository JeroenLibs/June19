...
namespace june19 {
	...
	enum class j19action {Unknown,Click,Select,Activate,Draw,Check,UnCheck};
	...
	typedef void (*j19callback)(j19gadget* source, j19action action);
